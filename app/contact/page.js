...
export default function ContactPage() {
  return (
    <div className="animate-fade-in">
      ...
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-cyan-600 via-blue-600 to-cyan-700 rounded-2xl p-8 md:p-12 mb-12 shadow-xl">
        <div className="relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Get In Touch</h1>
          <p className="text-xl text-cyan-50 mb-6 max-w-2xl">
            Contact us via email or phone for inquiries, quotations, and support. We're here to help you find the perfect tools.
          </p>
          
          {/* Quick Contact Buttons */}
          <div className="flex flex-wrap gap-4">
            <a 
              href="mailto:info@zetatoolz.com" 
              className="group inline-flex items-center gap-3 bg-white text-cyan-600 px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all hover:scale-105"
            >
            ...
            <a 
              ...
              className="group inline-flex items-center gap-3 bg-green-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-600 hover:shadow-lg transition-all hover:scale-105"
            >
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-gray-900 mb-1 group-hover:text-cyan-600 transition-colors">Email</h3>
              <p className="text-cyan-600 font-semibold">info@zetatoolz.com</p>
              <p className="text-sm text-gray-500 mt-2">Send us your inquiries anytime</p>
            </div>
          </div>
        </a>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-gray-900 mb-1 group-hover:text-green-600 transition-colors">WhatsApp</h3>
              <p className="text-green-600 font-semibold">+92 301 6866308</p>
              <p className="text-sm text-gray-500 mt-2">Chat with us instantly</p>
            </div>
          </div>
        </a>
